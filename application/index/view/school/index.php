...
<div role="tabpanel" class="tab-pane" id="user" style="display:block;">
	<div class="check-div form-inline row">
				<div class="col-xs-2">
                    <a href="{:url('create')}"><button class="btn btn-yellow btn-xs" data-toggle="modal" data-target="#addUser" id="create">添加学校</button></a>
		</div>
        <div class="col-xs-10">
            <form method="get" action="{:url('index')}" id="searchForm">
                <div class="col-xs-7">
                    ...
                    <input type="text" name="city" value="{$Think.get.city}" class="form-control input-sm"
                           placeholder="输入城市搜索">
	...
	<div class="data-div">
		...
		<div class="tablebody">
			...
			<div class="row cont_nowrap">
                ...
                <div class="col-xs-3 "  title="{$row_->title}">
                  {$row_->title}
                </div>
				<div class="col-xs-1 ">
					{$row_->lishu}
