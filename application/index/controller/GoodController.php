...
class GoodController extends BaseController {
    ...
    public function index(Request $request) {
       ...
       $rule = ['cate_id' => 'number','type_id'=>'number|in:1,2','index_show'=>'number|in:1','sort_type'=>'desc'];
        ...
        return $this->fetch('index', ['list_' => $list_,'list_school'=>$list_school,'list_cate'=>$list_cate,'url'=>$url,'page_str'=>$page_str]);
    }
    ...
    public function create(Request $request) {
        $data = $request->param();
        $list_school= School::getListAll();
        return $this->fetch('', ['list_school' => $list_school,'title'=>'添加资料','act'=>'save']);
    ...
    public function edit(Request $request) {
       ...
       // dump($row_->type);exit;
        ...
        //dump($row_);
        return $this->fetch('',['row_'=>$row_,'title'=>'修改资料'.$row_->title,'act'=>'update','referer'=>$referer,'list_cate'=>$list_cate,'list_school'=>$list_school]);
    }
